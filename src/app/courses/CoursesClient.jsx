        ...
        <div className="container mx-auto px-4">
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              />
              <button type="submit" className="absolute right-3 top-1/2 -translate-y-1/2 bg-blue-600 text-white p-3 rounded-lg">
                <FaSearch />
              </button>
            </div>
          </form>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={handleResetFilters} className="text-sm text-blue-600">
                  Reset All
                </button>
              </div>
          ...
          <div className="lg:w-3/4">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => setShowFilters(!showFilters)} className="lg:hidden bg-gray-200 p-3 rounded-lg">
                <FaFilter />
              </button>
            </div>
